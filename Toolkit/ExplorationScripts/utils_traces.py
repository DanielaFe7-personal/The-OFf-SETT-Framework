...
def obtain_clc_nomenclature():
    ...
    path = str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/Evian/aux_data/clc-nomenclature-c_2.xls"
...
path = str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/COMMUNES.xlsx"
dictionary_communeName = nameCommune(path) # e.g., 'FR74001': 'Abondance',

"Add to our LIS_seasonaly_all.csv their names "
df_name_GG_lis = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/GrandGeneve/LIS/LIS_seasonaly_all.csv", dictionary_communeName)
df_name_GG_lst = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/GrandGeneve/LST/LST_seasonaly_all.csv", dictionary_communeName)
"Add to our LIS_seasonaly_all.csv their names "
df_name_Ev_lis = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/Evian/LIS/LIS_seasonaly_all.csv", dictionary_communeName)
df_name_Ev_lst = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/Evian/LST/LST_seasonaly_all.csv", dictionary_communeName)
"Add to our LIS_seasonaly_all.csv their names "
df_name_Fr_lis = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/Fribourg/LIS/LIS_seasonaly_all.csv", dictionary_communeName)
df_name_Fr_lst = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/Fribourg/LST/LST_seasonaly_all.csv", dictionary_communeName)

print("Finish loading the 3 LIS/LST cs from Traces data ...")

"Add to our CLC.csv their names "
"If it is CLC, we mapp as well the nomenclature"
df_name_GG_clc = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/GrandGeneve/CLC/CLC.csv", dictionary_communeName, True)
df_name_Ev_clc = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/Evian/CLC/CLC.csv", dictionary_communeName, True)
df_name_Fr_clc = add_communeName(str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/Spectral_Indices_Dataset/Fribourg/CLC/CLC.csv", dictionary_communeName, True)
...
GG_path = str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/StudyAreas_Boundaries_Map/COMMUNES_GrandGeneve_4326.gpkg"
Fb_path = str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/StudyAreas_Boundaries_Map/COMMUNES_Fribourg_4326.gpkg"
Ev_path = str(Path.cwd().parent.parent)+"/SeTT_CommonInputData/StudyAreas_Boundaries_Map/COMMUNES_Evian_4326.gpkg"
